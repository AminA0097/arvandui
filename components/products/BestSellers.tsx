// components/products/BestSellers.tsx
"use client";
 ...
 * Displays top-selling products in an auto-scrolling carousel
 */
                ...
                <div className="overflow-hidden" ref={emblaRef}>
                    <div className="flex">
                        {products.map((product, index) => (
                            <div
                                key={product.id}
                                className="flex-[0_0_80%] md:flex-[0_0_33.33%] lg:flex-[0_0_25%] px-3"
                            >
                                <Link
