        ...
        <section className="py-16 md:py-24">
            <div className="container mx-auto px-4 md:px-6">
                <div className="flex items-end justify-between mb-10 flex-wrap gap-4">
                    ...
                    <Link href="/products" className="text-sm text-muted-foreground hover:text-primary transition flex items-center gap-1">
                        View all
                    ...
                    <div className="flex">
                      ...
                      New
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <h3 className="font-medium mt-1 group-hover:text-primary transition line-clamp-1">{product.name}</h3>
                ...
                <div className="mt-8 h-[2px] bg-muted rounded-full overflow-hidden">
                    <div
                        ...
                        style={{
                            width: scrollSnaps.length ? `${((selectedIndex + 1) / scrollSnaps.length) * 100}%` : '0%',
                        }}
                    />
                </div>
            </div>
